...
router.use(function (req, res, next) {
  ...
  router.post('/no-warning-answer', function (req, res) {
    ...
    if (noWarning == "increase"){
      ...
      res.redirect('/v02-2/choosewarnings-customise/locations-no-warnings-found')
    }


     else {
      // Send user to success page
      res.redirect('/v02-2/choosewarnings-customise/flood-warnings-success')
    }
  ...
  router.get('/flood-warning-answer', function (req, res) {
    ...
    if (floodWarning == "customise"){
      // Send user to next page
      res.redirect('/v02-2/choosewarnings/customise-settings')
    }


     else {
      // Send user to success page
      res.redirect('/v02-2/choosewarnings/flood-warnings-set')
    }
  ...
  router.get('/flood-warning-answer-customise', function (req, res) {
    ...
    if (floodWarningCustomise == "complex"){
      ...
      // Send user to success page
      res.redirect('/v02-2/choosewarnings/warnings-set-success')
    }
  ...
  router.post('/flood-edit-answer', function (req, res) {
    ...
    if (floodEdit == "customise"){
      // Send user to next page
      res.redirect('/v02-2/choosewarnings-edit/customise-settings')
    }


     else {
      // Send user to success page
      res.redirect('/v02-2/choosewarnings-edit/are-you-sure')
    }
